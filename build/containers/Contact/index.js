    ...
    render() {
        ...
        return (React.createElement(ScrollView, null,
            ...
            React.createElement(View, { style: { paddingHorizontal: theme.screenPadding } },
                ...
                React.createElement(ScrollView, { horizontal: true, showsHorizontalScrollIndicator: false }, organizations.map((org, ix) => (React.createElement(Cause, { key: org.id, title: org.name, img: images[ix % (images.length)] })))),
